            ...
            <div class="card border-secondary mb-3">
                ...
                <div class="card card-body">
                    ...
                    <a href="<?php echo URLROOT . '/posts/show/' . $post->postId; ?>"
                       class="card-link text-decoration-none">Read More</a>
                    <!--                    <a href="-->
                    <?php //echo URLROOT . '/posts/show/' . $post->postId; ?><!--" class="btn btn-outline-secondary">Read-->
                    <!--                        More</a>-->
                </div>
